...
class AppColor {
  static const Color primaryColor = Color(0xFF080818);
  static const Color secondaryColor = Color.fromARGB(255, 3, 8, 104);
  ...
  static const Color yellow = Color(0xFFF9A725);
