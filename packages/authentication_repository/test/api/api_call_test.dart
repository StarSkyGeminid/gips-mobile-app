...
void main() {
  group('Authentication Repository', () {
    ...
    group('Register', () {
      ...
      const email = 'johndoelorem@20.213.83.47:8080';
      ...
      setUp(() async {
        baseUri = Uri.https('20.213.83.47:8080', '/api/signup');
        ...
        const result = '''
{
    ...
    "data": {
        ...
        "profilePic": "https://20.213.83.47:8080/api/profile/8e856259-09e1-45c5-a12b-f3573d05ec6e.png",
        ...
        const result = '''
{
    ...
    group('Login', () {
      ...
      setUp(() async {
        baseUri = Uri.https('20.213.83.47:8080', '/api/login');
        ...
        const result = '''
{
    ...
    group('Reset Password', () {
      ...
      setUp(() {
        baseUri = Uri.parse('https://20.213.83.47:8080/api/reset-password');
      });
